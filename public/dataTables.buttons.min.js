...
(function(d) {
	...
	d.extend(r.prototype, {
		...
		_expandButton: function(a, b, c, e) {
			...
			for (var k = 0, h = b.length; k < h; k++) {
				...
				if (t) if (d.isArray(t)) this._expandButton(a, t, c, e);
				else {
			...
			if (!b._buttonsHandled) {
				var c = function(e) {
					for (var g = 0, f = e.length; g < f; g++) {
						var k = e[g].conf,
							h = e[g].node;
						k.key && (k.key === a ? (b._buttonsHandled = !0, d(h).click()) : !d.isPlainObject(k.key) || k.key.key !== a || k.key.shiftKey && !b.shiftKey || k.key.altKey && !b.altKey || k.key.ctrlKey && !b.ctrlKey || k.key.metaKey && !b.metaKey || (b._buttonsHandled = !0, d(h).click()));
	...
	r.buttonSelector = function(a, b) {
		for (var c = [], e = function(a, b, c) {
			for (var d, g, f = 0, h = b.length; f < h; f++) if (d = b[f]) g = c !== n ? c + f : f + "", a.push({
				node: d.node,
				name: d.conf.name,
				idx: g
			...
			else if (null === a || a === n || "*" === a) for (h = 0, f = k.length; h < f; h++) c.push({
				inst: b,
				node: k[h].node
			});
			...
			else if ("string" === typeof a) if (-1 !== a.indexOf(",")) for (k = a.split(","), h = 0, f = k.length; h < f; h++) g(d.trim(k[h]), b);
			...
			else if (-1 !== a.indexOf(":name")) for (a = a.replace(":name", ""), h = 0, f = k.length; h < f; h++) k[h].name === a && c.push({
				inst: b,
				node: k[h].node
			});
	...
	m.Api.register("buttons.info()", function(a, b, c) {
		var e = this;
		if (!1 === a) return this.off("destroy.btn-info"), z(d("#datatables_buttons_info"), 400, function() {
			d(this).remove()
	...
	m.Api.register("buttons.exportInfo()", function(a) {
		...
		c === n || null === c ? c = null : (-1 !== c.indexOf("*") && (c = d.trim(c.replace("*", d("head > title").text()))), c = c.replace(/[^a-zA-Z0-9_\u00A1-\uFFFF\.,\-_ !\(\)]/g, ""), (b = A(b.extension)) || (b = ""), c += b);
		b = A(a.title);
